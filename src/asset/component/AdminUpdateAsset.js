    ...
    <div>
      {sessionStorage.getItem("role") === "Administrator" ? (
        <div>
          ...
          <div
            style={{
              backgroundImage: "url(/addAsset.jpg)",
          ...
          >
            <h1 align="center">
              <span style={{ color: "maroon" }}>Asset</span>
            </h1>
            <form>
              <table align="center">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        onChange={(e) =>
                          setState({
                            asset: { ...state.asset, userName: e.target.value },
                          })
                        }
                      ></input>
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        type="text"
                        placeholder="Enter Assetmanufacturer"
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        onChange={(e) => {
                          setState({
                            asset: {
                              ...state.asset,
                              assetMovementDate: e.target.value,
                            },
                          });
                      ...
                      ></input>
                      <span className="alert-danger">
                        {error.asset_Movement_dateError}
                      </span>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      ></input>
                      <span className="alert-danger">
                        {error.expected_delivery_dateError}
                      </span>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        type="text-light bg-success"
                        placeholder="Enter Asset Source Location"
                        value={state.asset.assetSourceLocation}
                        onChange={(e) =>
                          setState({
                            asset: {
                              ...state.asset,
                              assetSourceLocation: e.target.value,
                            },
                          })
                        }
                      ></input>
                      <span className="alert-danger">
                        {error.asset_source_locationError}
                      </span>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        type="text-success"
                        placeholder="Enter Asset Destination Location"
                        value={state.asset.assetDestinationLocation}
                        onChange={(e) =>
                          setState({
                            asset: {
                              ...state.asset,
                              assetDestinationLocation: e.target.value,
                            },
                          })
                        }
                      ></input>
                      <span className="alert-danger">
                        {error.asset_destination_locationError}
                      </span>
                    </td>
                  </tr>
                  <tr>
                      ...
                      <button
                        ...
                        onClick={(event) => {
                          ...
                          if (!state.asset.assetMovementDate) {
                            isValid = false;
                            err.asset_Movement_dateError =
                              "*Enter the asset movement date";
                          }

                          if (!state.asset.expectedDeliveryDate) {
                            isValid = false;
                            err.expected_delivery_dateError =
                              "*Enter the expected delivery date";
                          }

                          if (!state.asset.assetSourceLocation) {
                            isValid = false;
                            err.asset_source_locationError =
                              "*Enter the source location";
                          }

                          if (!state.asset.assetDestinationLocation) {
                            isValid = false;
                            err.asset_destination_locationError =
                              "*Enter the destnation location";
                          }
